...
const Ichkihujjatlar = () => {
    const {t} = useTranslation();
    const navigate = useNavigate();
    const menus = [
        { id: 1, path: "boshqaruvKodeksi", key: "codeOfGovernance", title: t("internalDocuments.menus.codeOfGovernance") },
        { id: 2, path: "ichkiNizomlar", key: "internalRegulations", title: t("internalDocuments.menus.internalRegulations") },
    ];
        ...
        <div className="flex w-fu flex-col min-h-screen bg-gray-50 font-sans antialiased">
            ...
            <BackGroundColor>
                <div className="container mx-auto   px-6 max-w-[1300px]">
                    {/* Breadcrumb */}
                    <Breadcrumb links={[{link: t("internalDocuments.title")}]}/>
