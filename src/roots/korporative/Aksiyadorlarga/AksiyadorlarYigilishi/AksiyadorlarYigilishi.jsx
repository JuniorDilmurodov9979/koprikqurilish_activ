        ...
        <div className="container max-w-[1200px] mx-auto px-4 sm:px-6">
          ...
          <Breadcrumb
            links={[
              ...
              { link: t("Aksiyadorlar yig'ilishi") },
            ]}
          />
          ...
          <div className="bg-white shadow-lg rounded-2xl p-6 sm:p-8 border border-gray-200">
            ...
            {/* Download Button */}
            <div className="flex items-center gap-5 mt-10 text-center sm:text-left">
              <a
                href="/aksiyadorlarumumiy.pdf"
                download="Aksiyadorlar_Yigilishi.pdf"
              ...
              >
                {t("downloadShareholdersMeeting")}
              </a>
              <a
                href="/2025_yil_yakunlari_buyicha_qaror.pdf"
                download="2025_yil_yakunlari_buyicha_qaror.pdf"
                className="inline-block bg-yellow-500 hover:bg-yellow-600 text-white px-6 py-3 rounded-lg shadow-md transition font-semibold"
              >
                📄 {t("yil_yakuni_2025")}
              </a>
...
export default AksiyadorlarYigilishi;
